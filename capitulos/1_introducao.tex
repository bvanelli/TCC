...
\begin{figure}[!ht]
    \centering
    \includegraphics[trim={0.3cm 0.55cm 0.2cm 0.4cm},clip,width=.9\linewidth]{robots-per-workers}
...
\begin{figure}[!ht]
     \centering
     \subfloat[][Asimo \cite{sakagami2002intelligent}, a socially interactive robot]{\includegraphics[height=8cm]{asimo}\label{subfig:asimo}}
     \hspace{0.3cm}
     \subfloat[][Interwheels \cite{braga2008intellwheels}, a assistive robot]{\includegraphics[height=8cm]{interwheels}\label{subfig:interwheels}}
     \hspace{0.3cm}
     \subfloat[][Pepper \cite{tanaka2015pepper}, a socially assistive robot]{\includegraphics[height=8cm]{pepper}\label{subfig:pepper}}
...
The third generation came in 2008, using a better 7DOF (Degrees of Freedom) arm and 3 finger gripper with tactile feedback. It also became a lot more user-friendly, applying the concepts of embodiment and presenting a less bulky body with smoother surfaces and less visible mechanical parts. The robot body was divided into a working side (in the back, where the manipulator stands) and a serving side (on the front, to interact with users) \cite{graf2009robotic}.
