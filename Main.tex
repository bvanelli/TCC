...
\tituloingles{Título em Inglês}   % Título do Trabalho em Inglês

\palavraschave{1. PalavraChave1. 2. PalavraChave2. 3. PalavraChave3.}  % 5 palavras-chave
\keywords{1. Keyword1. 2. Keyword2. 3. Keyword3.}   % 5 palavras-chave para resumo em inglês
...
\include{capitulos/2_fundamentacao} % Texto do cap2.tex
