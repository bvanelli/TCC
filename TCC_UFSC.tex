...
\usepackage[english]{UFSC-ECA-Monograph} % personalização da ABNTEX2
%\usepackage[portuguese]{UFSC-ECA-Monograph} % personalização da ABNTEX2 para escrita em portugues
...
\keywords{1. Care-o-bot. 2. ROS. 3. Predictive Control.}   % 5 key-words

\DEELautor{Brunno}{Vanelli}                  % Aluno autor do trabalho

\curso{Control and Automation Engineering}												% Ex: Engenharia Civil
